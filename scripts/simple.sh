...
## Fork of the SIMPLE pipeline for mapping EMS mutants
# Updated to use conda env rather than program installation
...
## Set up with conda
# conda create -n simple -c bioconda samtools bwa picard snpeff -y
# conda activate simple

## Need to manually install GATK as it isn't just a JAR now

# Generate output folders if needed
if ! [ -d ./output/ ]; then
    mkdir output
fi
...
# Add header for further gatk tools
